...
#' @export
#'
indikatorFigAndelGrVar_preberegnet2017 <- function(Andeler, outfile, tittel, width=800, height=700, sideTxt='Boområde/opptaksområde',
  ...
  mtext( c(N[,3], names(N)[3]), side=4, line=8.5, las=1, at=c(ypos, max(ypos)+diff(ypos)[1]), col=1, cex=cexgr, adj = 1)
