...
#' @export
#'
indikatorFigAndelGrVar_1aar <- function(Antall, outfile, tittel, width=600, height=800,
                                           decreasing=F, terskel=30, minstekrav = NA, minstekravTxt='Min',
                                           maal = NA, maalTxt='Mål', til100=FALSE, skriftStr=1.3,
                                           sideTxt='Behandlende sykehus')
  {
